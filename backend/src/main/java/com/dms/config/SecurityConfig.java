...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // allow frontend dev server at port 7000 plus other common dev ports
        configuration.setAllowedOrigins(List.of("http://localhost:7000", "http://localhost:8080", "http://localhost:3000"));
